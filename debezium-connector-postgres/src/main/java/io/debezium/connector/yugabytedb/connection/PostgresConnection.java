...
import io.debezium.connector.yugabytedb.PostgresValueConverter;
...
public class PostgresConnection extends JdbcConnection {
     ...
     * @throws SQLException
     */
    public SlotState ybgetReplicationSlotState(String slotName, String pluginName) throws SQLException {
        ServerInfo.ReplicationSlot slot;
        try {
            slot = ybreadReplicationSlotInfo(slotName, pluginName);
     ...
     */
    private ServerInfo.ReplicationSlot ybfetchReplicationSlotInfo(String slotName, String pluginName) throws SQLException {
     ...
     */
    @VisibleForTesting
    ServerInfo.ReplicationSlot ybreadReplicationSlotInfo(String slotName, String pluginName) throws SQLException, InterruptedException {
        final String database = database();
        ...
        for (int attempt = 1; attempt <= MAX_ATTEMPTS_FOR_OBTAINING_REPLICATION_SLOT; attempt++) {
            final ServerInfo.ReplicationSlot slot = ybfetchReplicationSlotInfo(slotName, pluginName);
            if (slot != null) {

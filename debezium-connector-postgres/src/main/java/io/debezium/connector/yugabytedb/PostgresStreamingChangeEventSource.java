...
public class PostgresStreamingChangeEventSource implements StreamingChangeEventSource<PostgresPartition, PostgresOffsetContext> {
    ...
    public PostgresStreamingChangeEventSource(PostgresConnectorConfig connectorConfig, Snapshotter snapshotter,
        ...
        typeRegistry = taskContext.schema().getTypeRegistry();
    }
    ...
    private void getChanges2(ChangeEventSourceContext context,
        ...
        while (context.isRunning() && (offsetContext.getStreamingStoppingLsn() == null ||
            ...
            GetChangesResponse response = this.syncClient.getChangesCDCSDK3(
                    ...
                    cp.getTerm(), cp.getIndex(), cp.getKey(), cp.getWrite_id());
            ...
            response.getResp().getCDCSDKProtoRecordsList().forEach(record -> {
                ...
                try {
                    ...
                    if (message.isTransactionalMessage()) {
                        ...
                        LOGGER.info("Received DDL message {}", message);
    ...
    private void getChanges(ChangeEventSourceContext context, PostgresPartition partition, PostgresOffsetContext offsetContext, final ReplicationStream stream)

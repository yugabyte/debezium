...
public class PgProtoReplicationMessage implements ReplicationMessage {
    ...
    public PgProtoReplicationMessage(CdcService.RowMessage rawMessage, TypeRegistry typeRegistry) {
    ...
    public Object getValue(String columnName, PostgresType type, String fullType, Common.DatumMessage datumMessage, final PgConnectionSupplier connection,

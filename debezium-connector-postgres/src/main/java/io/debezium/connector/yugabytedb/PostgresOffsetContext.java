...
public class PostgresOffsetContext implements OffsetContext {
    ...
    private PostgresOffsetContext(PostgresConnectorConfig connectorConfig, OpId lsn, OpId lastCompletelyProcessedLsn, OpId lastCommitLsn, String txId, Instant time,
                                  boolean snapshot,
    ...
    public static PostgresOffsetContext initialContext(PostgresConnectorConfig connectorConfig, PostgresConnection jdbcConnection, Clock clock, OpId lastCommitLsn,
                                                       OpId lastCompletelyProcessedLsn) {
        try {

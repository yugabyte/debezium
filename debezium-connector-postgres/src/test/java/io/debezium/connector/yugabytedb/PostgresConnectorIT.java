...
import io.debezium.connector.yugabytedb.PostgresConnectorConfig.LogicalDecoder;
...
public class PostgresConnectorIT extends AbstractConnectorTest {
    ...
    public void shouldValidateConfiguration() throws Exception {
        ...
        validateConfigField(validatedConfig, PostgresConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE);
    ...
    public void shouldProduceEventsWithInitialSnapshot() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(PostgresConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE);
        ...
        start(PostgresConnector.class, configBuilder.with(PostgresConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE).build());
        assertConnectorIsRunning();
    ...
    public void shouldReceiveChangesForChangeColumnDefault() throws Exception {
        ...
        try {
            final PostgresConnectorConfig config = new PostgresConnectorConfig(TestHelper.defaultConfig()
                    ...
                    .with(PostgresConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE)
                    .with(PostgresConnectorConfig.PUBLICATION_AUTOCREATE_MODE, Boolean.TRUE)
                    // .with(YugabyteDBConnectorConfig.SLOT_NAME, slotName)
                    .build());
    ...
    public void testCustomPublicationNameUsed() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(PostgresConnectorConfig.STREAM_ID, "cdc");

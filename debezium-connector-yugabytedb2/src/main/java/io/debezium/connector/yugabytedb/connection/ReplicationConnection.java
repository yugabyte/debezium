...
public interface ReplicationConnection extends AutoCloseable {
     ...
     */
    ReplicationStream startStreaming(OpId offset, WalPositionLocator walPosition) throws SQLException, InterruptedException;
     ...
     *
     * @param config a {@link YugabyteDBConnectorConfig} instance; may not be null
    ...
    interface Builder {
         ...
         */
        Builder withPublicationAutocreateMode(final YugabyteDBConnectorConfig.AutoCreateMode publicationAutocreateMode);
         ...
         */
        Builder withPlugin(final YugabyteDBConnectorConfig.LogicalDecoder plugin);
         ...
         * @return this instance
         * @see YugabyteDBConnectorConfig.TruncateHandlingMode
         */
        Builder withTruncateHandlingMode(final YugabyteDBConnectorConfig.TruncateHandlingMode truncateHandlingMode);
        ...
        Builder withTypeRegistry(YugabyteDBTypeRegistry yugabyteDBTypeRegistry);
         ...
         * @return this instance
         */
        Builder withSchema(YugabyteDBSchema schema);

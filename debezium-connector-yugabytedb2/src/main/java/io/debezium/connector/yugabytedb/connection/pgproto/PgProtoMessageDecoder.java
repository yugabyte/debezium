...
import io.debezium.connector.yugabytedb.connection.AbstractMessageDecoder;
import io.debezium.connector.yugabytedb.connection.ReplicationStream.ReplicationMessageProcessor;
import io.debezium.connector.yugabytedb.proto.PgProto;
...
public class PgProtoMessageDecoder extends AbstractMessageDecoder {
    ...
    @Override
    public void processNotEmptyMessage(final ByteBuffer buffer, ReplicationMessageProcessor processor, YugabyteDBTypeRegistry yugabyteDBTypeRegistry)

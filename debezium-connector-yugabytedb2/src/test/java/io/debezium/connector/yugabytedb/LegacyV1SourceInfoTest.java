    ...
    public void beforeEach() {
        source = new SourceInfo(new YugabyteDBConnectorConfig(
                Configuration.create()
                        .with(YugabyteDBConnectorConfig.SERVER_NAME, "serverX")
                        .with(YugabyteDBConnectorConfig.DATABASE_NAME, "serverX")
                        .with(YugabyteDBConnectorConfig.SOURCE_STRUCT_MAKER_VERSION, Version.V1)
                        .build()));

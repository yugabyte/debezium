...
/**
 * Unit test for {@link YugabyteDBSchema}
 *
 * @author Horia Chiorean (hchiorea@redhat.com)
 */
public class YugabyteDBSchemaIT {
    ...
    public void shouldLoadSchemaForExtensionPostgresTypes() throws Exception {
        TestHelper.executeDDL("postgres_create_tables.ddl");
        YugabyteDBConnectorConfig config = new YugabyteDBConnectorConfig(
                TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.INCLUDE_UNKNOWN_DATATYPES, true).build());
    ...
    public void shouldApplyFilters() throws Exception {
        ...
        YugabyteDBConnectorConfig config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(SCHEMA_EXCLUDE_LIST, "s1").build());
        final YugabyteDBTypeRegistry yugabyteDBTypeRegistry = TestHelper.getTypeRegistry();
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(SCHEMA_BLACKLIST, "s1").build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
            assertTablesIncluded("s2.a", "s2.b");
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(SCHEMA_EXCLUDE_LIST, "s.*").build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(SCHEMA_BLACKLIST, "s.*").build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.create()) {
            schema.refresh(connection, false);
            assertTablesExcluded("s1.a", "s2.a", "s1.b", "s2.b");
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.TABLE_EXCLUDE_LIST, "s1.A,s2.A").build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.TABLE_BLACKLIST, "s1.A,s2.A").build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
            assertTablesIncluded("s1.b", "s2.b");
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig()
                .with(SCHEMA_EXCLUDE_LIST, "s2")
                .with(YugabyteDBConnectorConfig.TABLE_EXCLUDE_LIST, "s1.A")
                .build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.TABLE_BLACKLIST, "s1.A")
                .build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.COLUMN_EXCLUDE_LIST, ".*aa")
                .build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.COLUMN_BLACKLIST, ".*aa")
                .build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.COLUMN_INCLUDE_LIST, ".*bb")
                .build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);
        ...
        config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.COLUMN_WHITELIST, ".*bb")
                .build());
        schema = TestHelper.getSchema(config, yugabyteDBTypeRegistry);
        try (YugabyteDBConnection connection = TestHelper.createWithTypeRegistry()) {
            schema.refresh(connection, false);

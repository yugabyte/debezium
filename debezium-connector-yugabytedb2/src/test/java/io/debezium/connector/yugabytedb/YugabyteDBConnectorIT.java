...
import static io.debezium.connector.yugabytedb.TestHelper.PK_FIELD;
import static io.debezium.connector.yugabytedb.TestHelper.topicName;
...
import io.debezium.connector.yugabytedb.YugabyteDBConnectorConfig.LogicalDecoder;
...
import io.debezium.connector.yugabytedb.junit.SkipTestDependingOnDecoderPluginNameRule;
import io.debezium.connector.yugabytedb.junit.SkipWhenDecoderPluginNameIs;
import io.debezium.connector.yugabytedb.junit.SkipWhenDecoderPluginNameIsNot;
...
/**
 * Integration test for {@link YugabyteDBConnector} using an {@link io.debezium.embedded.EmbeddedEngine}
 *
...
public class YugabyteDBConnectorIT extends AbstractConnectorTest {
    ...
    public void shouldNotStartWithInvalidSlotConfigAndUserRoles() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER)
        ...
        Configuration failingConfig = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.DATABASE_CONFIG_PREFIX + JdbcConfiguration.USER, "badboy")
                .with(YugabyteDBConnectorConfig.DATABASE_CONFIG_PREFIX + JdbcConfiguration.PASSWORD, "failing")
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER)
                // .with(PostgresConnectorConfig.SLOT_NAME, ReplicationConnection.Builder.DEFAULT_SLOT_NAME)
                .build();
    ...
    public void shouldValidateConfiguration() throws Exception {
        ...
        assertConfigurationErrors(validatedConfig, YugabyteDBConnectorConfig.HOSTNAME, 1);
        assertConfigurationErrors(validatedConfig, YugabyteDBConnectorConfig.USER, 1);
        assertConfigurationErrors(validatedConfig, YugabyteDBConnectorConfig.DATABASE_NAME, 1);
        assertConfigurationErrors(validatedConfig, YugabyteDBConnectorConfig.SERVER_NAME, 1);

        // validate the non required fields
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.PLUGIN_NAME, LogicalDecoder.DECODERBUFS.getValue());
        // validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SLOT_NAME, ReplicationConnection.Builder.DEFAULT_SLOT_NAME);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.PORT, YugabyteDBConnectorConfig.DEFAULT_PORT);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.MAX_QUEUE_SIZE, YugabyteDBConnectorConfig.DEFAULT_MAX_QUEUE_SIZE);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.MAX_BATCH_SIZE, YugabyteDBConnectorConfig.DEFAULT_MAX_BATCH_SIZE);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SNAPSHOT_FETCH_SIZE, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.POLL_INTERVAL_MS, YugabyteDBConnectorConfig.DEFAULT_POLL_INTERVAL_MILLIS);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SSL_MODE, YugabyteDBConnectorConfig.SecureConnectionMode.DISABLED);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SSL_CLIENT_CERT, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SSL_CLIENT_KEY, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SSL_CLIENT_KEY_PASSWORD, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SSL_ROOT_CERT, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SCHEMA_WHITELIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SCHEMA_BLACKLIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SCHEMA_EXCLUDE_LIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.TABLE_WHITELIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.TABLE_BLACKLIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.TABLE_EXCLUDE_LIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.COLUMN_BLACKLIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.COLUMN_EXCLUDE_LIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.COLUMN_WHITELIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.COLUMN_INCLUDE_LIST, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.MSG_KEY_COLUMNS, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL);
        ...
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.TIME_PRECISION_MODE, TemporalPrecisionMode.ADAPTIVE);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.DECIMAL_HANDLING_MODE, YugabyteDBConnectorConfig.DecimalHandlingMode.PRECISE);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.SSL_SOCKET_FACTORY, null);
        validateConfigField(validatedConfig, YugabyteDBConnectorConfig.TCP_KEEPALIVE, true);
    }

    @Test
    @Ignore
    public void shouldValidateReplicationSlotName() throws Exception {
        // CDCSDK : Not valid for YB
        Configuration config = Configuration.create()
                // .with(YugabyteDBConnectorConfig.SLOT_NAME, "xx-aa")
                .build();
        YugabyteDBConnector connector = new YugabyteDBConnector();
        Config validatedConfig = connector.validate(config.asMap());

        // assertConfigurationErrors(validatedConfig, YugabyteDBConnectorConfig.SLOT_NAME, 1);
    }
    ...
    public void shouldSupportSSLParameters() throws Exception {
        ...
        // SSL is enabled
        Configuration config = TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.SSL_MODE,
                YugabyteDBConnectorConfig.SecureConnectionMode.REQUIRED).build();
        start(YugabyteDBConnector.class, config, (success, msg, error) -> {
    ...
    public void shouldProduceEventsWithInitialSnapshot() throws Exception {
        ...
        start(YugabyteDBConnector.class, configBuilder.with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE).build());
        assertConnectorIsRunning();
    ...
    public void shouldConsumeMessagesFromSnapshot() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL.getValue())
                .with(YugabyteDBConnectorConfig.MAX_QUEUE_SIZE, recordCount / 2)
                .with(YugabyteDBConnectorConfig.MAX_BATCH_SIZE, 10)
                .with(YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, "s1");
        start(YugabyteDBConnector.class, configBuilder.build());
        assertConnectorIsRunning();
    ...
    public void shouldConsumeMessagesFromSnapshotOld() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.MAX_QUEUE_SIZE, recordCount / 2)
                .with(YugabyteDBConnectorConfig.MAX_BATCH_SIZE, 10)
                .with(YugabyteDBConnectorConfig.SCHEMA_WHITELIST, "s1");
        start(YugabyteDBConnector.class, configBuilder.build());
        assertConnectorIsRunning();
    ...
    public void shouldReceiveChangesForChangePKColumnDefinition() throws Exception {
        ...
        try {
            final YugabyteDBConnectorConfig config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig()
    ...
    public void shouldReceiveChangesForChangeColumnDefault() throws Exception {
        ...
        try {
            final YugabyteDBConnectorConfig config = new YugabyteDBConnectorConfig(TestHelper.defaultConfig()
                    .with(YugabyteDBConnectorConfig.INCLUDE_UNKNOWN_DATATYPES, Boolean.FALSE)
                    .with(YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, "default_change")
                    .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE)
                    .with(YugabyteDBConnectorConfig.PUBLICATION_AUTOCREATE_MODE, Boolean.TRUE)
                    // .with(YugabyteDBConnectorConfig.SLOT_NAME, slotName)
                    .build());
    ...
    public void shouldExecuteOnConnectStatements() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL.getValue())
                .with(YugabyteDBConnectorConfig.ON_CONNECT_STATEMENTS, "INSERT INTO s1.a (aa) VALUES (2); INSERT INTO s2.a (aa, bb) VALUES (2, 'hello;; world');")
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE);
        start(YugabyteDBConnector.class, configBuilder.build());
        assertConnectorIsRunning();
        waitForStreamingRunning();
    ...
    public void shouldNotProduceEventsWithInitialOnlySnapshot() throws InterruptedException {
        ...
        TestHelper.execute(SETUP_TABLES_STMT);
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL_ONLY.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void shouldProduceEventsWhenAlwaysTakingSnapshots() throws InterruptedException {
        TestHelper.execute(SETUP_TABLES_STMT);
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.ALWAYS.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE);
        start(YugabyteDBConnector.class, configBuilder.build());
        assertConnectorIsRunning();
        waitForSnapshotToBeCompleted();
    ...
    public void shouldTakeExcludeListFiltersIntoAccount() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SCHEMA_EXCLUDE_LIST, "s2")
                .with(YugabyteDBConnectorConfig.TABLE_EXCLUDE_LIST, ".+b")
                .with(YugabyteDBConnectorConfig.COLUMN_EXCLUDE_LIST, ".+bb");
    ...
    public void shouldTakeBlacklistFiltersIntoAccount() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SCHEMA_BLACKLIST, "s2")
                .with(YugabyteDBConnectorConfig.TABLE_BLACKLIST, ".+b")
                .with(YugabyteDBConnectorConfig.COLUMN_BLACKLIST, ".+bb");
    ...
    public void shouldTakeColumnIncludeListFilterIntoAccount() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.COLUMN_INCLUDE_LIST, ".+aa,.+cc");
    ...
    public void shouldRemoveWhiteSpaceChars() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, "s1")
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, tableWhitelistWithWhitespace);
    ...
    public void shouldRemoveWhiteSpaceCharsOld() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SCHEMA_WHITELIST, "s1")
                .with(YugabyteDBConnectorConfig.TABLE_WHITELIST, tableWhitelistWithWhitespace);
    ...
    public void shouldCloseTxAfterTypeQuery() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.INCLUDE_UNKNOWN_DATATYPES, true);
    ...
    public void shouldReplaceInvalidTopicNameCharacters() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, "s1")
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "s1\\.dbz_878_some\\|test@data");
    ...
    public void shouldNotSendEmptyOffset() throws InterruptedException, SQLException {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "s1.a")
    ...
    public void shouldRegularlyFlushLsn() throws InterruptedException, SQLException {
        ...
        try (final YugabyteDBConnection connection = TestHelper.create()) {
    ...
    public void shouldRegularlyFlushLsnWithTxMonitoring() throws InterruptedException, SQLException {
        ...
        Configuration config = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "s1.a")
                .with(YugabyteDBConnectorConfig.PROVIDE_TRANSACTION_METADATA, true)
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
        waitForStreamingRunning("postgres", TestHelper.TEST_SERVER);
    ...
    public void shouldAllowForCustomSnapshot() throws InterruptedException {
        TestHelper.execute(SETUP_TABLES_STMT);
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.CUSTOM.getValue())
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE_CLASS, CustomTestSnapshot.class.getName())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE)
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void shouldAllowForSelectiveSnapshot() throws InterruptedException {
        TestHelper.execute(SETUP_TABLES_STMT);
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.ALWAYS.name())
        ...
        start(YugabyteDBConnector.class, configBuilder
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE_TABLES, "s2.a")
                .build());
        assertConnectorIsRunning();
    ...
    public void shouldAllowForExportedSnapshot() throws Exception {
        ...
        TestHelper.execute(SETUP_TABLES_STMT);
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.EXPORTED.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE)
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void exportedSnapshotShouldNotSkipRecordOfParallelTx() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.EXPORTED.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE)
                .with(YugabyteDBConnectorConfig.MAX_QUEUE_SIZE, 2)
                .with(YugabyteDBConnectorConfig.MAX_BATCH_SIZE, 1)
                .build();
        final YugabyteDBConnection pgConnection = TestHelper.create();
    ...
    public void shouldResumeStreamingFromSlotPositionForCustomSnapshot() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.CUSTOM.getValue())
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE_CLASS, CustomStartFromStreamingTestSnapshot.class.getName())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE)
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void customSnapshotterSkipsTablesOnRestart() throws Exception {
        ...
        config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.CUSTOM.getValue())
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE_CLASS, CustomPartialTableTestSnapshot.class.getName())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.FALSE)
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void testCustomSnapshotterSnapshotCompleteLifecycleHook() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.CUSTOM.getValue())
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE_CLASS, CustomLifecycleHookTestSnapshot.class.getName())
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
    ...
    private String getConfirmedFlushLsn(YugabyteDBConnection connection) throws SQLException {
...
//            .with(YugabyteDBConnectorConfig.STREAM_ID, "3ec5241cea9c44d9a891245c357f0533");
    ...
    public void testEmptySchemaWarningAfterApplyingFilters() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL_ONLY.getValue())
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "my_products");
    ...
    public void testCustomPublicationNameUsed() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.STREAM_ID, "cdc");
    ...
    public void shouldRewriteIdentityKey() throws InterruptedException {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.INITIAL.getValue())
                .with(YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, "s1,s2")
                // rewrite key from table 'a': from {pk} to {pk, aa}
                .with(YugabyteDBConnectorConfig.MSG_KEY_COLUMNS, "(.*)1.a:pk,aa");
    ...
    public void shouldNotIssueWarningForNoMonitoredTablesAfterApplyingFilters() throws Exception {
        ...
        TestHelper.execute(SETUP_TABLES_STMT);
        TestHelper.execute(INSERT_STMT);
        Configuration config = TestHelper.defaultConfig().with(YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, "s2").build();
    ...
    public void shouldClearDatabaseWarnings() throws Exception {
        ...
        TestHelper.execute(INSERT_STMT);
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.POLL_INTERVAL_MS, "10")
                .build();
    ...
    public void shouldConfigureSubscriptionsFromTableFilters() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                // .with(PostgresConnectorConfig.PUBLICATION_NAME, "cdc")
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "public.numeric_table,public.text_table,s1.a,s2.a")
                .with(YugabyteDBConnectorConfig.PUBLICATION_AUTOCREATE_MODE, YugabyteDBConnectorConfig.AutoCreateMode.FILTERED.getValue());
    ...
    public void shouldThrowWhenAutocreationIsDisabled() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                //
                // .with(YugabyteDBConnectorConfig.SLOT_NAME, "cdc")
                .with(YugabyteDBConnectorConfig.PUBLICATION_AUTOCREATE_MODE, YugabyteDBConnectorConfig.AutoCreateMode.DISABLED.getValue());
    ...
    public void shouldProduceMessagesOnlyForConfiguredTables() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                // .with(PostgresConnectorConfig.PUBLICATION_NAME, "cdc")
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "s2.a")
                .with(YugabyteDBConnectorConfig.PUBLICATION_AUTOCREATE_MODE, YugabyteDBConnectorConfig.AutoCreateMode.FILTERED.getValue());
    ...
    public void shouldThrowWhenTableFiltersIsEmpty() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                // .with(PostgresConnectorConfig.PUBLICATION_NAME, "cdc")
                .with(YugabyteDBConnectorConfig.PUBLICATION_AUTOCREATE_MODE, YugabyteDBConnectorConfig.AutoCreateMode.FILTERED.getValue())
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "nonexistent.table");
    ...
    public void shouldEmitNoEventsForSkippedCreateOperations() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SKIPPED_OPERATIONS, Envelope.Operation.UPDATE.code())
                .build();
        start(YugabyteDBConnector.class, config);
        assertConnectorIsRunning();
        waitForStreamingRunning("postgres", TestHelper.TEST_SERVER);
    ...
    private CompletableFuture<Void> batchInsertRecords(long recordsCount, int batchSize) {
        String insertStmt = "INSERT INTO t1(j, jb, x, u) " +

...
public class OutboxEventRouterIT extends AbstractConnectorTest {
    ...
    private static Configuration.Builder getConfigurationBuilder(SnapshotMode snapshotMode) {
        return TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, snapshotMode.getValue())
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.SCHEMA_INCLUDE_LIST, "outboxsmtit")
                .with(YugabyteDBConnectorConfig.TABLE_INCLUDE_LIST, "outboxsmtit\\.outbox");
    }
}

...
public class YugabyteDBMetricsIT extends AbstractRecordsProducerTest {
    ...
    public void twoRecordsInQueue() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(YugabyteDBConnectorConfig.SNAPSHOT_MODE, SnapshotMode.NEVER)
                .with(YugabyteDBConnectorConfig.DELETE_STREAM_ON_STOP, Boolean.TRUE)
                .with(YugabyteDBConnectorConfig.MAX_QUEUE_SIZE, 10)
                .with(YugabyteDBConnectorConfig.MAX_BATCH_SIZE, 1)
                .with(YugabyteDBConnectorConfig.POLL_INTERVAL_MS, 100L)
                .with(YugabyteDBConnectorConfig.MAX_QUEUE_SIZE_IN_BYTES, 10000L);
    ...
    public void oneRecordInQueue() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(YugabyteDBConnectorConfig.MAX_QUEUE_SIZE, 10)
                .with(YugabyteDBConnectorConfig.MAX_BATCH_SIZE, 1)
                .with(YugabyteDBConnectorConfig.POLL_INTERVAL_MS, 5000L)
                .with(YugabyteDBConnectorConfig.MAX_QUEUE_SIZE_IN_BYTES, 10L);
